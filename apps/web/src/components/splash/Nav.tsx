      ...
      <div className="mx-auto max-w-[1400px] px-6">
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="text-lg font-semibold tracking-tight text-brand-600">RealtyAI</span>
          </Link>
      ...
      {open && (
        ...
        >
          <div className="px-6 py-4 space-y-4">
            <Link href="#features" onClick={() => setOpen(false)} className="block text-sm text-gray-600">
              Features
            </Link>
            <Link href="#demo" onClick={() => setOpen(false)} className="block text-sm text-gray-600">
              Demo Access
            </Link>
