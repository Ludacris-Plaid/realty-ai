  ...
  return (
    <main className="flex min-h-[100dvh] items-center justify-center bg-gradient-to-b from-amber-50/50 to-white p-6">
      ...
      >
        ...
        <h1 className="text-2xl font-bold tracking-tight text-gray-900 text-center">Get demo access</h1>
        <p className="mt-1 text-sm text-gray-500 text-center">Create your Athena account — free, no credit card</p>
